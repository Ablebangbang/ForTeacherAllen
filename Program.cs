...
namespace ConsoleApp2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //-----------------------------------------------------------------------------------------------------------
            //倒正triangle
            Func<int, int, string> funcCenter = (rows, currentRow) =>  new string(' ', currentRow - 1) + new string('*', 2 * (rows - currentRow) + 1);
            ...
            //--------------------------------------------------------------------------------------------------------------
            //倒右triangle
            Func<int, int, string> funcRight = (rows, currentRow) => new string('*', rows - currentRow + 1).PadLeft(rows);
